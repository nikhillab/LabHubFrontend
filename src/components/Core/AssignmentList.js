      ...
      <Link to={`/assignment/${type}/${id}`}>
        <div className='icon-box' data-aos='fade-up' data-aos-delay='100'>
          ...
          <p className='targetDate'>
            {moment(props.assignment.targetDate).format("YYYY-MM-DD")}
          </p>
        </div>
      </Link>
    </div>
